  ...
  return (
    <g className={'bird ' + (className ?? '')}>
      ...
      <g className="head">
        ...
        <path d={`M${x + 7} 124 l 8 -3 l -7 6 z`} fill="var(--color-alias-illustration-orange-526)" />
        <circle cx={x + 3} cy="124" r="1.8" fill="var(--color-alias-illustration-mauve-813)" />
      </g>
      <line x1={x - 3} y1="150" x2={x - 3} y2="156" stroke="var(--color-alias-illustration-orange-1000)" strokeWidth="1.5" />
      <line x1={x + 3} y1="150" x2={x + 3} y2="156" stroke="var(--color-alias-illustration-orange-1000)" strokeWidth="1.5" />
    </g>
  )
}
...
export default function Day12() {
  return (
    <svg className="scn s12" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      <style>{`
      ...
      `}</style>
      <defs><linearGradient id="s12sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="var(--color-alias-illustration-neutral-0)" /><stop offset="1" stopColor="var(--color-alias-illustration-blue-97)" /></linearGradient></defs>
      <rect width="430" height="260" fill="url(#s12sky)" />
      <g className="c1" fill="var(--color-alias-illustration-neutral-0)"><ellipse cx="330" cy="88" rx="30" ry="14" /><circle cx="314" cy="84" r="13" /><circle cx="344" cy="82" r="16" /></g>
      <path className="wire" d="M0 156 Q 215 168 430 156" stroke="var(--color-alias-illustration-blue-778)" strokeWidth="2" fill="none" />
