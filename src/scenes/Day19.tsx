...
export default function Day19() {
  return (
    <svg className="scn s19" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      <style>{`
      ...
      <path d="M0 232 Q 215 222 430 232 L430 260 L0 260 Z" fill="var(--color-alias-illustration-green-205)" />
      {/* хвост */}
      <path className="tail" d="M258 224 Q 300 214 296 178 Q 294 164 282 168 Q 292 176 284 196 Q 276 214 254 214 Z" fill="var(--color-alias-illustration-blue-667)" />
      {/* кот */}
      <g className="head">
        <path d="M172 232 Q 168 168 215 168 Q 262 168 258 232 Z" fill="var(--color-alias-illustration-blue-639)" />
        <g className="ear"><path d="M182 176 L176 150 L200 166 Z" fill="var(--color-alias-illustration-blue-639)" /><path d="M186 170 L184 158 L195 166 Z" fill="var(--color-alias-illustration-red-125)" /></g>
        <g className="ear earR"><path d="M248 176 L254 150 L230 166 Z" fill="var(--color-alias-illustration-blue-639)" /><path d="M244 170 L246 158 L235 166 Z" fill="var(--color-alias-illustration-red-125)" /></g>
        <path d="M215 168 L215 214" stroke="var(--color-alias-illustration-blue-736)" strokeWidth="2" opacity="0.5" />
      </g>
      {/* трава спереди */}
      ...
      <g fill="var(--color-alias-illustration-orange-263)" opacity=".9">
        <circle cx="134" cy="210" r="4" /><circle cx="296" cy="216" r="3.5" />
      </g>
      {/* бабочка */}
      <g className="fly">
        <g className="wing"><ellipse cx="96" cy="150" rx="9" ry="6" fill="var(--color-alias-illustration-rose-419)" /></g>
