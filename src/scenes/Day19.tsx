...
export default function Day19() {
  return (
    <svg className="scn s19" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      `}</style>
      <rect width="430" height="260" fill="#f2f8ef" />
      <path d="M0 232 Q 215 222 430 232 L430 260 L0 260 Z" fill="#cdeac6" />
      {/* хвост */}
      <path className="tail" d="M258 224 Q 300 214 296 178 Q 294 164 282 168 Q 292 176 284 196 Q 276 214 254 214 Z" fill="#a7adb8" />
      {/* кот */}
      <g className="head">
        <path d="M172 232 Q 168 168 215 168 Q 262 168 258 232 Z" fill="#adb3bd" />
        <g className="ear"><path d="M182 176 L176 150 L200 166 Z" fill="#adb3bd" /><path d="M186 170 L184 158 L195 166 Z" fill="#ffb9c8" /></g>
        <g className="ear earR"><path d="M248 176 L254 150 L230 166 Z" fill="#adb3bd" /><path d="M244 170 L246 158 L235 166 Z" fill="#ffb9c8" /></g>
        <path d="M215 168 L215 214" stroke="#9299a4" strokeWidth="2" opacity="0.5" />
      </g>
      {/* трава спереди */}
      <g fill="#8CDb6f">
      ...
      {/* бабочка */}
      <g className="fly">
        <g className="wing"><ellipse cx="96" cy="150" rx="9" ry="6" fill="#ff9ec4" /></g>
        <ellipse cx="105" cy="150" rx="9" ry="6" fill="#ffb9d4" />
        <circle cx="101" cy="150" r="2.4" fill="#7a5a52" />
      </g>
    </svg>
  )
}
