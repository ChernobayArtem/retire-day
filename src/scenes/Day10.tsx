...
export default function Day10() {
  return (
    <svg className="scn s10" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      `}</style>
      <path d="M0 158 L40 168 L86 158 L140 170 L200 158 L260 168 L320 158 L380 170 L430 160 V260 H0 Z" fill="#ABF394" />
      <g><line x1="330" y1="130" x2="330" y2="180" stroke="#8a7a5a" strokeWidth="3" /><path d="M330 132 l24 8 l-24 8 z" fill="#ff7aa8" /></g>
      <g fill="#8CDb6f">
        <path className="blade" d="M120 210 q -5 -22 2 -30 q 5 12 1 30 z" />
        <path className="blade bl2" d="M300 208 q 5 -24 -2 -32 q -5 14 0 32 z" />
      </g>
      <g className="snail">
        <line className="trail" x1="-12" y1="196" x2="30" y2="196" stroke="#dff4dc" strokeWidth="4" strokeLinecap="round" strokeDasharray="3 6" />
        <g className="eye" stroke="#5a4b52" strokeWidth="2" strokeLinecap="round">
          <line x1="56" y1="184" x2="60" y2="166" /><line x1="50" y1="185" x2="46" y2="168" />
        </g>
        <circle cx="60" cy="165" r="2.6" fill="#5a4b52" /><circle cx="46" cy="167" r="2.6" fill="#5a4b52" />
        <g className="body">
          <path d="M14 196 Q 12 182 30 181 L 46 182 Q 62 184 60 192 Q 60 196 54 196 Z" fill="#f7c98a" />
        </g>
        <circle cx="33" cy="178" r="15" fill="#e39b5b" />
        <circle cx="33" cy="178" r="9" fill="#f2b978" />
        <path d="M33 178 a 6 6 0 1 0 5 3" fill="none" stroke="#c9823f" strokeWidth="2.5" />
        <path d="M53 188 q 5 4 9 0" fill="none" stroke="#b8774d" strokeWidth="1.6" strokeLinecap="round" />
      </g>
    </svg>
  )
}
