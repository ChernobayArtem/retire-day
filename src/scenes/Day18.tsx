...
export default function Day18() {
  return (
    <svg className="scn s18" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="cloud" fill="#ffffff"><ellipse cx="120" cy="86" rx="30" ry="13" /><circle cx="104" cy="82" r="12" /><circle cx="134" cy="80" r="15" /></g>
      <g className="cloud cloud2" fill="#f7fbff" opacity=".8"><ellipse cx="324" cy="112" rx="22" ry="9" /><circle cx="312" cy="109" r="9" /><circle cx="336" cy="107" r="11" /></g>
      <path className="waveB" d={wavePath(196, -9)} fill="#bfe1fb" />
      {/* кораблик */}
      <g className="boat">
        <path d="M172 184 L258 184 L238 209 Q215 217 192 209 Z" fill="#ffffff" stroke="#c7dceb" strokeWidth="2.4" />
        <path d="M194 184 L215 148 L236 184 Z" fill="#ffffff" stroke="#c7dceb" strokeWidth="2.4" />
        <line x1="215" y1="150" x2="215" y2="184" stroke="#d2e3ef" strokeWidth="2.2" />
        <path d="M215 150 L233 182 L215 182 Z" fill="#f5fbff" />
        <ellipse className="splash" cx="260" cy="188" rx="4" ry="5" fill="#7ac2ff" />
      </g>
      <path className="waveF" d={wavePath(206, 8)} fill="#8fcbf6" />
    </svg>
  )
}
