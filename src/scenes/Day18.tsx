  ...
  return (
    ...
    >
      ...
      <g className="cloud" fill="var(--color-alias-illustration-neutral-0)">
        <ellipse cx="120" cy="86" rx="30" ry="13" />
        <circle cx="104" cy="82" r="12" />
        <circle cx="134" cy="80" r="15" />
      </g>
      <g className="cloud cloud2" fill="var(--color-alias-illustration-blue-14)" opacity=".8">
        <ellipse cx="324" cy="112" rx="22" ry="9" />
        <circle cx="312" cy="109" r="9" />
        <circle cx="336" cy="107" r="11" />
      </g>
      <path
        className="waveB"
        d={wavePath(196, -9)}
        fill="var(--color-alias-illustration-blue-361)"
      />
      {/* кораблик */}
      <g className="boat">
        <path
          d="M172 184 L258 184 L238 209 Q215 217 192 209 Z"
          fill="var(--color-alias-illustration-neutral-0)"
          stroke="var(--color-alias-illustration-blue-375)"
          strokeWidth="2.4"
        />
        <path
          d="M194 184 L215 148 L236 184 Z"
          fill="var(--color-alias-illustration-neutral-0)"
          stroke="var(--color-alias-illustration-blue-375)"
          strokeWidth="2.4"
        />
        <line
          ...
          x2="215"
          y2="184"
          stroke="var(--color-alias-illustration-blue-319)"
          strokeWidth="2.2"
        />
      ...
      <path
        className="waveF"
        d={wavePath(206, 8)}
        fill="var(--color-alias-illustration-blue-556)"
      />
    </svg>
  )
}
