// День 23 — пляжный мяч
const BALL_COLORS = ['#ff6f7d', '#ffd45e', '#5cc4c4', '#ffffff', '#ff9ec4', '#7ac2ff']
...
export default function Day23() {
  return (
    <svg className="scn s23" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      `}</style>
      <rect width="430" height="260" fill="#eaf6ff" />
      <circle cx="330" cy="82" r="24" fill="#ffe08a" opacity=".85" />
      <g className="cloud" fill="#ffffff"><ellipse cx="112" cy="96" rx="28" ry="11" /><circle cx="98" cy="92" r="11" /><circle cx="126" cy="90" r="13" /></g>
      <rect y="150" width="430" height="60" fill="#bfe6f7" />
      <path className="wave" d="M-20 154 q 30 -8 60 0 q 30 8 60 0 q 30 -8 60 0 q 30 8 60 0 q 30 -8 60 0 q 30 8 60 0 q 30 -8 60 0 L470 152 L470 210 L-20 210 Z" fill="#9fd8f2" />
      <path className="foam" d="M70 168 q 28 -7 56 0 M276 174 q 24 -6 48 0" fill="none" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" />
      <path d="M0 200 Q 215 184 430 200 L430 260 L0 260 Z" fill="#fbe9c8" />
      {/* мяч */}
      <g className="ball">
        {ballWedges(215, 202, 26).map((w, i) => (
          <path key={i} d={w.d} fill={w.c} />
        ))}
        <circle cx="215" cy="202" r="26" fill="none" stroke="#e7d9b8" strokeWidth="1.5" />
        <circle cx="206" cy="193" r="6" fill="#ffffff" opacity="0.45" />
      </g>
      {/* ракушка */}
      <g className="shell">
        <path d="M300 232 Q 300 214 316 214 Q 332 214 332 232 Z" fill="#ffc6d6" />
        <g stroke="#f2a3ba" strokeWidth="1.5" fill="none"><path d="M316 214 L316 232" /><path d="M308 216 L311 232" /><path d="M324 216 L321 232" /></g>
      </g>
    </svg>
  )
}
