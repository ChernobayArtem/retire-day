...
function Petal({ x, y, dx, rot, dur, delay }: { x: number; y: number; dx: string; rot: string; dur: string; delay: string }) {
  return (
    <ellipse
      className="petal"
      cx={x}
...
export default function Day11() {
  return (
    <svg className="scn s11" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      <style>{`
