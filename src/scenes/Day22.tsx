...
function Drop({ x, y, delay }: { x: number; y: number; delay: string }) {
  return (
    <line
      ...
      x2={x}
      y2={y + 10}
      stroke="var(--color-alias-illustration-blue-597)"
      strokeWidth="2.5"
      strokeLinecap="round"
...
export default function Day22() {
  return (
    ...
    >
      ...
      <g className="cloud c1" fill="var(--color-alias-illustration-blue-389)">
        <ellipse cx="150" cy="70" rx="34" ry="14" />
        <circle cx="132" cy="66" r="14" />
        <circle cx="168" cy="64" r="16" />
      </g>
      <g className="cloud c2" fill="var(--color-alias-illustration-blue-250)">
        <ellipse cx="300" cy="92" rx="26" ry="10" />
        <circle cx="288" cy="88" r="10" />
        <circle cx="312" cy="87" r="12" />
      </g>
      <g className="rain">
      ...
      <g className="umbrella">
        <line
          ...
          x2="215"
          y2="224"
          stroke="var(--color-alias-illustration-brown-667)"
          strokeWidth="3"
        />
        <path
          d="M215 224 q -10 2 -8 -8"
          fill="none"
          stroke="var(--color-alias-illustration-brown-667)"
          strokeWidth="3"
          strokeLinecap="round"
        />
        <path
          d="M165 172 Q 175 146 215 144 Q 255 146 265 172 Q 240 162 227 172 Q 220 160 215 172 Q 210 160 203 172 Q 190 162 165 172 Z"
          fill="var(--color-alias-illustration-red-500)"
        />
        <path
          className="shine"
          d="M185 160 Q 205 146 225 151"
          fill="none"
          stroke="var(--color-alias-illustration-red-188)"
          strokeWidth="3"
          strokeLinecap="round"
        />
        <path
          d="M165 172 Q 175 146 215 144 Q 255 146 265 172"
          fill="none"
          stroke="var(--color-alias-illustration-red-875)"
          strokeWidth="2"
        />
      ...
      <ellipse
        ...
        rx="44"
        ry="4"
        fill="var(--color-alias-illustration-blue-125)"
        opacity=".75"
      />
      <ellipse
        className="ripple rp1"
        cx="200"
        cy="240"
        rx="14"
        ry="4"
        fill="none"
        stroke="var(--color-alias-illustration-blue-542)"
        strokeWidth="1.5"
      />
      <ellipse
        className="ripple rp2"
        cx="235"
        cy="241"
        rx="14"
        ry="4"
