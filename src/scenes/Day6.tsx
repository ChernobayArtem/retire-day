  ...
  return (
    <svg className="scn s6" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(320 98)">
        <g className="rays" stroke="#ffcf4d" strokeWidth="4" strokeLinecap="round">
          {rays.map((a) => {
            const r = (a * Math.PI) / 180
            return <line key={a} x1={Math.cos(r) * 40} y1={Math.sin(r) * 40} x2={Math.cos(r) * 52} y2={Math.sin(r) * 52} />
          })}
        </g>
        <circle className="sun" r="30" fill="#ffd45e" />
      </g>
      <g className="c2" fill="#eef6ff"><ellipse cx="120" cy="186" rx="40" ry="20" /><circle cx="100" cy="180" r="18" /><circle cx="138" cy="178" r="22" /></g>
      <g className="c1" fill="#ffffff"><ellipse cx="88" cy="112" rx="30" ry="15" /><circle cx="72" cy="108" r="14" /><circle cx="102" cy="106" r="17" /></g>
      <g className="cross" fill="#ffffff"><ellipse cx="300" cy="98" rx="30" ry="14" /><circle cx="284" cy="94" r="13" /><circle cx="314" cy="92" r="15" /></g>
      <g className="bird" fill="none" stroke="#9bb8cf" strokeWidth="2" strokeLinecap="round">
