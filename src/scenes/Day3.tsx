...
export default function Day3() {
  return (
    <svg className="scn s3" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      `}</style>
      <rect width="430" height="260" fill="#f8fbff" />
      <g className="cloud" fill="#edf5fb">
        <ellipse cx="312" cy="78" rx="30" ry="12" /><circle cx="296" cy="75" r="12" /><circle cx="327" cy="73" r="15" />
      </g>
      <path d="M0 150 L44 160 L92 150 L150 162 L215 150 L280 162 L340 150 L392 162 L430 152 V260 H0 Z" fill="#c9f3b8" />
      <ellipse className="shadow" cx="215" cy="164" rx="34" ry="7" fill="#8cae82" />
      <g className="dust" fill="#dcd3e0">
      ...
      <g className="drop">
        <g className="chute">
          <path d="M177 92 A 38 38 0 0 1 253 92 Q 234 79 215 89 Q 196 79 177 92 Z" fill="#b8a4ff" />
          <path d="M177 92 Q 196 82 215 88 Q 234 82 253 92" fill="none" stroke="#a08de6" strokeWidth="2" />
          <line x1="183" y1="91" x2="198" y2="126" stroke="#c9bdf2" strokeWidth="1.8" />
          <line x1="215" y1="88" x2="215" y2="126" stroke="#c9bdf2" strokeWidth="1.8" />
          <line x1="247" y1="91" x2="232" y2="126" stroke="#c9bdf2" strokeWidth="1.8" />
        </g>
        <g className="box">
          <rect x="193" y="126" width="44" height="30" rx="6" fill="#ff8f5e" />
          <rect x="193" y="126" width="44" height="10" rx="5" fill="#ffb27a" />
          <rect x="211" y="126" width="8" height="30" fill="#ff7a45" />
          <path d="M211 126 q -11 -10 -16 0 q 8 5 20 4 q 12 1 20 -4 q -5 -10 -16 0" fill="#ffd45e" />
        </g>
      </g>
    </svg>
  )
