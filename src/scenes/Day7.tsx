  ...
  return (
    ...
    >
      ...
      <ellipse
        ...
        rx="150"
        ry="15"
        fill="var(--color-alias-illustration-orange-105)"
      />
      <ellipse
        cx="215"
        cy="218"
        rx="50"
        ry="8"
        fill="var(--color-alias-illustration-brown-111)"
        opacity=".55"
      />
      <g
        fill="none"
        stroke="var(--color-alias-illustration-brown-222)"
        strokeWidth="4"
        strokeLinecap="round"
      >
      ...
      <g className="leaf">
        <path
          d="M150 216 C 132 206 132 193 150 191 C 158 201 158 211 150 216 Z"
          fill="var(--color-alias-illustration-green-872)"
        />
      </g>
      <g className="leaf lf2">
        <path
          d="M282 216 C 300 206 300 193 282 191 C 274 201 274 211 282 216 Z"
          fill="var(--color-alias-illustration-green-513)"
        />
      </g>
      <g className="cup">
        <path
          d="M244 178 q 22 0 20 22 q -2 16 -22 12"
          fill="none"
          stroke="var(--color-alias-illustration-orange-789)"
          strokeWidth="8"
        />
        <path
          d="M186 170 L244 170 L237 214 Q 215 222 193 214 Z"
        ...
        <ellipse
          ...
          rx="29"
          ry="8"
          fill="var(--color-alias-illustration-brown-1000)"
        />
        <path
          className="shine"
          d="M197 168 Q 207 164 217 167"
          fill="none"
          stroke="var(--color-alias-illustration-orange-912)"
          strokeWidth="2"
          strokeLinecap="round"
        />
        <ellipse
          ...
          ry="8"
          fill="none"
          stroke="var(--color-alias-illustration-orange-509)"
          strokeWidth="3"
        />
      </g>
    </svg>
