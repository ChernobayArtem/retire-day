...
export default function Day7() {
  return (
    <svg className="scn s7" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      `}</style>
      <ellipse cx="215" cy="222" rx="150" ry="15" fill="#f2ece7" />
      <ellipse cx="215" cy="218" rx="50" ry="8" fill="#e5d9d1" opacity=".55" />
      <g fill="none" stroke="#ccbfb6" strokeWidth="4" strokeLinecap="round">
      ...
      <g className="leaf"><path d="M150 216 C 132 206 132 193 150 191 C 158 201 158 211 150 216 Z" fill="#74AA63" /></g>
      <g className="leaf lf2"><path d="M282 216 C 300 206 300 193 282 191 C 274 201 274 211 282 216 Z" fill="#8CDb6f" /></g>
      <g className="cup">
        <path d="M244 178 q 22 0 20 22 q -2 16 -22 12" fill="none" stroke="#ff8f5e" strokeWidth="8" />
        <path d="M186 170 L244 170 L237 214 Q 215 222 193 214 Z" fill="#ff8f5e" />
        <ellipse className="coffee" cx="215" cy="170" rx="29" ry="8" fill="#5f4436" />
        <path className="shine" d="M197 168 Q 207 164 217 167" fill="none" stroke="#b98d70" strokeWidth="2" strokeLinecap="round" />
        <ellipse cx="215" cy="170" rx="29" ry="8" fill="none" stroke="#ffb27a" strokeWidth="3" />
      </g>
    </svg>
  )
}
