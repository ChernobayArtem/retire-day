...
function Windows({
  ...
  for (let r = 0; r < rows; r++)
    for (let c = 0; c < cols; c++) w.push([x + c * 12, y + r * 14, (r + c) % 3])
  return (
    <g fill="var(--color-alias-illustration-orange-158)">
      {w.map(([wx, wy, k], i) => (
        <rect
          key={i}
          className={'win ' + cls + ' k' + k}
          x={wx}
          y={wy}
          width="6"
          height="7"
...
export default function Day24() {
  return (
    ...
    >
      ...
      `}</style>
      <defs>
        <linearGradient id="s24sky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="var(--color-alias-illustration-blue-292)" />
          <stop offset="1" stopColor="var(--color-alias-illustration-blue-694)" />
        </linearGradient>
      </defs>
      ...
      <circle
        ...
        cy="66"
        r="18"
        fill="var(--color-alias-illustration-yellow-636)"
      />
      <g className="cloud" fill="var(--color-alias-illustration-blue-500)" opacity="0.6">
        <ellipse cx="120" cy="72" rx="30" ry="10" />
        <circle cx="140" cy="68" r="11" />
      </g>
      {/* здания */}
      <rect
        x="72"
        ...
        height="90"
        rx="6"
        fill="var(--color-alias-illustration-blue-875)"
      />
      <rect
        x="138"
        y="120"
        ...
        height="120"
        rx="6"
        fill="var(--color-alias-illustration-blue-833)"
      />
      <rect
        x="198"
        y="140"
        ...
        height="100"
        rx="6"
        fill="var(--color-alias-illustration-blue-903)"
      />
      <rect
        x="266"
        y="108"
        ...
        height="132"
        rx="6"
        fill="var(--color-alias-illustration-blue-847)"
      />
      <line
        x1="291"
        y1="108"
        x2="291"
        y2="92"
        stroke="var(--color-alias-illustration-blue-847)"
        strokeWidth="2"
      />
      ...
      <rect
        ...
        height="88"
        rx="6"
        fill="var(--color-alias-illustration-blue-889)"
      />
      ...
      <g className="car">
        <rect
          ...
          height="6"
          rx="3"
          fill="var(--color-alias-illustration-blue-806)"
        />
        <circle cx="20" cy="248" r="3.5" fill="var(--color-alias-illustration-yellow-636)" />
        <circle cx="36" cy="248" r="3.5" fill="var(--color-alias-illustration-red-375)" />
      </g>
    </svg>
  )
}
