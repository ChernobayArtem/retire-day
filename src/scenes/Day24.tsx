...
export default function Day24() {
  return (
    <svg className="scn s24" viewBox="0 0 430 260" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
      ...
      `}</style>
      <defs><linearGradient id="s24sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#dfe1f2" /><stop offset="1" stopColor="#9a9ec9" /></linearGradient></defs>
      <rect width="430" height="260" fill="url(#s24sky)" />
      <circle className="moon" cx="324" cy="66" r="18" fill="#fff0b0" />
      <g className="cloud" fill="#c8cbe4" opacity="0.6"><ellipse cx="120" cy="72" rx="30" ry="10" /><circle cx="140" cy="68" r="11" /></g>
      {/* здания */}
      <rect x="72" y="150" width="58" height="90" rx="6" fill="#5f6592" />
      <rect x="138" y="120" width="52" height="120" rx="6" fill="#6e74a6" />
      <rect x="198" y="140" width="60" height="100" rx="6" fill="#565b86" />
      <rect x="266" y="108" width="50" height="132" rx="6" fill="#6a70a0" />
      <line x1="291" y1="108" x2="291" y2="92" stroke="#6a70a0" strokeWidth="2" />
      <circle cx="291" cy="90" r="2.5" fill="#ff9e9e" />
      <rect x="324" y="152" width="46" height="88" rx="6" fill="#5a608c" />
      ...
      {/* дорога и машина */}
      <rect y="240" width="430" height="20" fill="#3f4468" />
      <g className="car"><rect x="18" y="244" width="20" height="6" rx="3" fill="#7780aa" /><circle cx="20" cy="248" r="3.5" fill="#fff0b0" /><circle cx="36" cy="248" r="3.5" fill="#ff9e8a" /></g>
    </svg>
  )
}
